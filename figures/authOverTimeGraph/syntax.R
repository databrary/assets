...
ggplot(dataset, aes(x = V2, y = people)) + 
  ...
  theme(
    ...
    axis.ticks.x = element_line(color="#333333",size=1),
  ...
  ylab("") +
  xlab("") +
  annotate("text", x=as.Date('2015-02-15'), y=250, label = "Authorized Investigators", color = "#2FA38C", size=10) + 
  annotate("text", x=as.Date('2016-04-01'), y=75, label = "Institutions", color="#EE9374", size=10)
